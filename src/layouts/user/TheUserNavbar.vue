  ...
  <nav class="the-navbar">
    <div class="container mx-auto px-5">
      <nav class="flex justify-between">
        ...
        <ul>
          <li><a href="https://github.com/amirrr1987/themovie"><svg fill="#FFF" height="32" aria-hidden="true" viewBox="0 0 16 16" version="1.1" width="32" data-view-component="true" class="octicon octicon-mark-github v-align-middle">
